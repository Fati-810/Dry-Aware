<?php
/*
*	Euthemians Visual Composer Remove Unsupported Elements
*
...
if ( function_exists( 'vc_remove_element' ) ) {
	...
	add_action( 'init', 'crocal_eutf_remove_vc_shortcodes' );

	if ( !function_exists( 'crocal_eutf_remove_vc_shortcodes' ) && function_exists( 'vc_remove_element' ) ) {

		function crocal_eutf_remove_vc_shortcodes() {

			if ( !crocal_eutf_vc_social_elements_visibility() ) {
				//Social
			...
			if ( !crocal_eutf_vc_wp_elements_visibility() ) {
				//WordPress
			...
			if ( !crocal_eutf_vc_charts_visibility() ) {
				//Charts
				vc_remove_element('vc_round_chart');
				vc_remove_element('vc_line_chart');
			}

			if ( !crocal_eutf_vc_woo_visibility() ) {
				//WooCommerce
			...
			if ( !crocal_eutf_vc_other_elements_visibility() ) {
				//Other
...
if ( is_admin() ) {
	if ( ! function_exists('crocal_eutf_remove_vc_boxes') ) {
		function crocal_eutf_remove_vc_boxes(){
	...
	add_action('do_meta_boxes', 'crocal_eutf_remove_vc_boxes');
}
